from PyQt5.QtWidgets import QFrame, QGridLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QSpinBox, QVBoxLayout, QWidget
...
def build_remote_desktop_page(window):
    ...
    grid.addWidget(window.remote_desktop_status_label, 1, 1, 1, 5)
